    ...
    <div style='width:100%'>
        <div style='margin-top:200px'>
            <table style='float:left;width:40%'>
                <thead>
                    <tr>
                        <th class='bordernlright'>Code</th>
                        <th class='bordernlright'>Base HT</th>
                        <th class='bordernlright'>Taux</th>
                        <th class='bordernlright'>Taxe</th>
                    </tr>
                </thead>
                <tbody>
                    <tr><td>TVV</td>
            ...
            <table style='margin-left:10px;float:left;width:40%'>
                <thead>
                    <tr><th class='bordernlright'>Total HT</th><th class='bordernlright'>Escompte</th>
                        <th class='bordernlright'>Port</th><th class='bordernlright'>Total TTC</th>
                        <th class='bordernlright'>Acompte</th></tr>
                    <tr><td style='text-align:right'>141 500,00</td>
                        <td style='text-align:right'>0,00</td>
                        <td style='text-align:right'></td>
                        <td style='text-align:right'>133 717,50</td>
            ...
            <div style='float:left;border: 1px black solid;border-radius: 10px;margin-left:10px;'>
                <div style='border: 1px black solid;padding:6px 6px 6px 20px;border-radius: 10px;'>NET A PAYER</div>
                <div style='float:right;padding-right: 10px'>10000,00</div>
            </div>
            <div style='clear:both'>
                Arrêtée la présente Facture à la somme de : <?php echo asLetters(133718)." Francs CFA"; ?>
            </div>
            <div><b>N.B.</b> Les marchandises vendues ne sont ni reprises, ni échangées.</div>
        </div>
    <br/>
    <br/>
