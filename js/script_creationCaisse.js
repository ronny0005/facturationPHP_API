    ...
    function ajouterCaisse(){
        if($_GET("CA_No")==null){
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.location.replace("indexMVC.php?module=3&action=14&acte=ajoutOK&CA_No="+data.CA_No);
                }, 
                error: function(data) {
                    alert(data);
                }
            ...
            $.ajax({
                ...
                data : $("#formCaisse").serialize(),
                success: function(data) {
                    window.location.replace("indexMVC.php?module=3&action=14&acte=modifOK&CA_No="+data.CA_No);
                } , 
                error: function(data) {
                    alert(data);
                }
